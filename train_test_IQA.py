...
def main(config):
    ...
    folder_path = {
        'live': '/home/pan/dataset/databaserelease2/',
        ...
        'PIQ23': '/home/pan/dataset/Dataset',
    }
    ...
    for i in range(config.train_test_num):
        ...
        srcc_all[i], plcc_all[i], model_paras, train_loss = solver.train()
        if train_loss < min_loss:
            min_loss = train_loss
            torch.save(model_paras, 'best_jod.plk')
